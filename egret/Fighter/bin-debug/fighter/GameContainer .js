...
(function (fighter) {
    ...
    var GameContainer = (function (_super) {
        ...
        function GameContainer() {
            ...
            _this.enemyFighters = []; // 敌方飞机
            _this.enemyFightersTimer = new egret.Timer(1000); // 创建敌机的定时器
            _this.myBullets = []; // 我的子弹
            _this.enemyBullets = []; // 敌方子弹
         ...
         * 响应Touch
         */
        GameContainer.prototype.touchHandler = function (event) {
         ...
         * 创建敌机
         */
        GameContainer.prototype.createEnemyFighter = function (event) {
            var enemyFighter = fighter.Airplane.produce("f2_png", 1000);
         ...
         * 创建子弹(包括我的子弹和敌机的子弹)
         */
        GameContainer.prototype.createBulletHandler = function (event) {
            var bullet;
        ...
        GameContainer.prototype.gameViewUpdate = function (event) {
            ...
            var speedOffset = 60 / fps; // FPS下降的时候，运动速度加快
            // 我的子弹运动
            var i = 0;
            var bullet;
